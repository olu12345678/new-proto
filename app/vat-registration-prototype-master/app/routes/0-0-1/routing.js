module.exports = function (router) {
    ...
    router.post('/' + version + '/business/business-entity', function (req, res) {
        ...
        if (type_of_business == "Partnership") {
            ...
            if (req.session.data['on-behalf'] == "Yes") {
                res.redirect(301, '/' + version + '/business/confirm-personal-details')
            } else {
    ...
    router.post('/' + version + '/business/date-of-birth', function (req, res) {
        ...
        if (req.session.data['on-behalf'] == "No") {
    ...
    router.post('/' + version + '/business/check-your-answers-business', function (req, res) {
        var first_name = req.session.data['first-name']
        var surname = req.session.data['last-name']

        if ((first_name == "Joe") && (surname == "Bloggs")) {
