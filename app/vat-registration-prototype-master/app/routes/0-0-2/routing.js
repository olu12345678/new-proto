module.exports = function (router) {
    ...
    router.post('/' + version + '/transactor-details/whos-the-application-for', function (req, res) {
        req.session.application_for = req.session.data['on-behalf']
        if (req.session.application_for == "No") {
            res.redirect(301, '/' + version + '/transactor-details/do-you-have-a-organisation-name')
        } else {
    ...
    router.post('/' + version + '/transactor-details/national-insurance-number', function (req, res) {
        ...
        res.redirect(301, '/' + version + '/transactor-details/postcode-lookup')
    })
    ...
    router.post('/' + version + '/transactor-details/confirm-your-address', function (req, res) {
        ...
        res.redirect(301, '/' + version + '/transactor-details/telephone-number')
    })
    ...
    router.post('/' + version + '/company_details/company-registration-number', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/confirm-company-details')
    })

    router.post('/' + version + '/company_details/confirm-company-details', function (req, res) {
        req.session.before_you_start_completed = "Yes";
    ...
    router.post('/' + version + '/business/CT-UTR', function (req, res) {
        ...
        if (type_of_partnership == "Limited liability partnership") {
            res.redirect(301, '/' + version + '/business/self-assessment-postcode')
        } else {
            res.redirect(301, '/' + version + '/business/check-your-answers-business')
        }
    ...
    router.post('/' + version + '/applicant_details/any-previous-names', function (req, res) {
        if (req.body.changed_name == "yes") {
            ...
            res.redirect(301, '/' + version + '/applicant_details/post-code-lookup')
        }
    })
    ...
    router.post('/' + version + '/applicant_details/lived-at-address-less-3-years', function (req, res) {
        ...
        if (req.body.address_3_years == "yes") {
            ...
            res.redirect(301, '/' + version + '/applicant_details/email-address')
        }
    })
