module.exports = function (router) {
    ...
    router.post('/' + version + '/more-than-85k-single-30-days', function (req, res) {
        if (req.session.threshold == "Yes") {
            ...
            res.redirect(301, '/' + version + '/voluntarily-vat')
        } else {
            res.redirect(301, '/' + version + '/estimated-turnover-next-12-months')
        }
    })

    router.post('/' + version + '/voluntarily-vat', function (req, res) {
    ...
    router.post('/' + version + '/zero-rated-sales', function (req, res) {
        if (req.session.data['zero-rated-sales'] == "Yes") {
    ...
    router.post('/' + version + '/mtd-voluntarily-information', function (req, res) {
    ...
    router.post('/' + version + '/business-address', function (req, res) {
        if (req.session.data['business-address-same'] == "Yes") {
            res.redirect(301, '/' + version + '/business-mobile-number')
        } else {
            res.redirect(301, '/' + version + '/previous-address')
        }
    })
    ...
    router.post('/' + version + '/business-mobile-number', function (req, res) {
        res.redirect(301, '/' + version + '/business-website-question')
    })

    router.post('/' + version + '/business-website-question', function (req, res) {
        if (req.session.data['website'] == "Yes") {
            res.redirect(301, '/' + version + '/business-website-url')
        } else {
            res.redirect(301, '/' + version + '/contact-preference')
        }
    })

    router.post('/' + version + '/business-website-url', function (req, res) {
        res.redirect(301, '/' + version + '/contact-preference')
    })
    ...
    router.post('/' + version + '/main-income', function (req, res) {
        res.redirect(301, '/' + version + '/total-value-turnover-next-12-months')
    })

    router.post('/' + version + '/total-value-turnover-next-12-months', function (req, res) {
    ...
    router.post('/' + version + '/regularly-exceed-on-vat-purchases', function (req, res) {
        res.redirect(301, '/' + version + '/buy-or-sell-to-another-eu-member')
    })

    router.post('/' + version + '/buy-or-sell-to-another-eu-member', function (req, res) {
