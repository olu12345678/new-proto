module.exports = function (router) {
    ...
    var version = "0-16-0"; /* CHANGE ME TO THE VERSION YOURE WORKING ON */
    ...
    router.post('/' + version + '/business/business-entity-vat-group', function (req, res) {
        if (req.session.data['type_of_business_entity'] == "UK company") {
    ...
    router.post('/' + version + '/business/non-uk-address', function (req, res) {
        res.redirect(301, '/' + version + '/business/confirm-home-address')
    })

    router.post('/' + version + '/business/confirm-home-address', function (req, res) {
    ...
    router.post('/' + version + '/business/self-assessment-postcode', function (req, res) {
        req.session.dob_month = req.body.dob_month;
        if (req.session.data['fixed-establishment'] == "No") {
            res.redirect(301, '/' + version + '/business/overseas-identifer')
        } else {
            res.redirect(301, '/' + version + '/business/check-your-answers-business')
        }
    })
    ...
    router.post('/' + version + '/business/overseas-identifer', function (req, res) {
        res.redirect(301, '/' + version + '/business/check-your-answers-business')
    })
