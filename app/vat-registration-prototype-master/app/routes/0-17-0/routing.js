module.exports = function (router) {
    ...
    var version = "0-17-0"; /* CHANGE ME TO THE VERSION YOURE WORKING ON */
    ...
    router.post('/' + version + '/eligibility/business-activities-next-12-months', function (req, res) {
        if (req.body.international_activities == "Yes") {
            ...
            // res.redirect(301, '/' + version + '/eligibility/northern_ireland_activities')
        }
    })

    router.post('/' + version + '/eligibility/northern_ireland_activitiesv2', function (req, res) {
        if (req.body.northern_ireland_activities == "Yes") {
            res.redirect(301, '/' + version + '/eligibility/receive-goods-in-northern-ireland')
        } else {
            res.redirect(301, '/' + version + '/eligibility/taken-over-a-business')
        }
    })

    router.post('/' + version + '/eligibility/receive-goods-in-northern-ireland', function (req, res) {
        if (req.body.recieve_goods_ni == "Yes") {
            res.redirect(301, '/' + version + '/eligibility/sell-or-move-goods-ni')
        } else {
            res.redirect(301, '/' + version + '/eligibility/')
        }
    })

    router.post('/' + version + '/eligibility/sell-or-move-goods-ni', function (req, res) {
        if (req.body.recieve-goods-ni == "Yes") {
            res.redirect(301, '/' + version + '/eligibility/')
        } else {
            res.redirect(301, '/' + version + '/eligibility/')
        }
    ...
    router.post('/' + version + '/business/business-entity-overseas', function (req, res) {
        if (req.session.data['type_of_business'] == "Non UK Company") {
            res.redirect(301, '/' + version + '/errors/business-activities-next-12-months')
        } else {
            res.redirect(301, '/' + version + '/eligibility/agricultural-flat-rate')
        }
