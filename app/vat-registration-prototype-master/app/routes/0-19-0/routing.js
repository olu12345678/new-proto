module.exports = function (router) {
    ...
    var version = "0-19-0"; /* CHANGE ME TO THE VERSION YOURE WORKING ON */
    ...
    router.post('/' + version + '/eligibility/fixed-establishment-in-uk', function (req, res) {
        if (req.session.data['fixed-establishment'] == "No") {
            res.redirect(301, '/' + version + '/business/business-entity-overseas')
        } else {
    ...
    router.post('/' + version + '/transactor-details/whos-the-application-for', function (req, res) {
        if (req.session.data['type_of_business'] == "VAT group") {
            res.redirect(301, '/' + version + '/eligibility/gone-over-threshold')
        } else {
    ...
    router.post('/' + version + '/applicant_details/whats-the-role-in-business', function (req, res) {
        if (req.session.data['type_of_business'] == "Sole trader" || req.session.data['type_of_business'] == "Non-established taxable person (NETP)") {
    ...
    router.post('/' + version + '/eligibility/gone-over-threshold', function (req, res) { // Backward look
        ...
        if (req.session.data['fixed-establishment'] == "No") {
            if (req.session.data['threshold'] == "Yes") {
                req.session.data['voluntarily_vat'] = "No";
                res.redirect(301, '/' + version + '/eligibility/estimated-turnover-next-12-months')
            } else {
                req.session.data['voluntarily_vat'] = "Yes";
                res.redirect(301, '/' + version + '/eligibility/estimated-turnover-next-12-months')
            }
        } else {
    ...
    router.post('/' + version + '/eligibility/more-than-85k-next-30-days', function (req, res) {
        ...
        if (req.session.data['next_30_day_period'] == "Yes") {
            ...
            if (req.session.data['type_of_business'] == "VAT group") {
                res.redirect(301, '/' + version + '/eligibility/estimated-turnover-next-12-months')
            } else if (req.session.data['fixed-establishment'] == "No") {
                req.session.data['voluntarily_vat'] = "Yes";
                res.redirect(301, '/' + version + '/eligibility/estimated-turnover-next-12-months')
            } else {
                req.session.data['voluntarily_vat'] = "Yes"
    ...
    router.post('/' + version + '/company_details/northern_ireland_activities', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/receive-goods-in-northern-ireland')
    })

    router.post('/' + version + '/company_details/receive-goods-in-northern-ireland', function (req, res) {
        req.session.data['activities_sic_started'] = "No";
        req.session.data['activities_sic_completed'] = "Yes";
        res.redirect(301, '/' + version + '/business/task-list')
    })

    router.post('/' + version + '/company_details/sell-or-move-goods-ni', function (req, res) {
        req.session.data['activities_sic_started'] = "No";
        req.session.data['activities_sic_completed'] = "Yes";
        res.redirect(301, '/' + version + '/business/task-list')
    })
    ...
    router.post('/' + version + '/eligibility/zero-rated-goods', function (req, res) {
        res.redirect(301, '/' + version + '/eligibility/zero-rated-turnover')
    })

    router.post('/' + version + '/eligibility/own-racehorses-buy-sell-property', function (req, res) {
        if (req.session.classic_services == "Yes") {
            req.session.data['on_behalf'] = "Someone else's";
            res.redirect(301, '/' + version + '/eligibility/vat-registration-reason')
        } else {
    ...
    router.post('/' + version + '/business/business-entity-vat-group', function (req, res) {
        if (req.session.data['type_of_business'] == "UK company") {
            ...
            res.redirect(301, '/' + version + '/business/full-name')
        } else if (req.session.data['type_of_business'] == "Partnership") {
            res.redirect(301, '/' + version + '/business/type-of-partnership-vat-group')
        } else if (req.session.data['type_of_business'] == "Other") {
            res.redirect(301, '/' + version + '/business/business-entity-other')
        } else {
            res.redirect(301, '/' + version + '/business/business-entity-vat-group')
        }
    })

    router.post('/' + version + '/business/type-of-partnership-vat-group', function (req, res) {
        if (req.session.data['type_of_partnership'] == "General partnership") {
            res.redirect(301, '/' + version + '/business/SA-UTR')
        } else if (req.session.data['type_of_partnership'] == "Limited partnership") {
            res.redirect(301, '/' + version + '/business/what-is-the-companies-reg-number')
        } else if (req.session.data['type_of_partnership'] == "Scottish partnership") {
            res.redirect(301, '/' + version + '/business/SA-UTR')
        } else if (req.session.data['type_of_partnership'] == "Scottish limited partnership") {
            res.redirect(301, '/' + version + '/business/what-is-the-companies-reg-number')
        } else if (req.session.data['type_of_partnership'] == "Limited liability partnership") {
            res.redirect(301, '/' + version + '/business/what-is-the-companies-reg-number')
        } else {
            res.redirect(301, '/' + version + '/business/type_of_partnership_vat_group')
        }
    })

    router.post('/' + version + '/business/business-entity-other-vat-group', function (req, res) {
        if (req.session.data['type_of_business'] == "Individual") {
            res.redirect(301, '/' + version + '/business/full-name')
        } else if (req.session.data['type_of_business'] == "Non UK Company") {
            res.redirect(301, '/' + version + '/business/non-uk-company-utr')
            ...
            res.redirect(301, '/' + version + '/business/business-entity-other-vat-group')
            ...
            res.redirect(301, '/' + version + '/business/have-CT-UTR')
        } else if (req.session.data['type_of_business'] == "Government Organisation or Public Body") {
            res.redirect(301, '/' + version + '/business/business-entity-other-vat-group')
    ...
    router.post('/' + version + '/business/non-uk-address', function (req, res) {
        res.redirect(301, '/' + version + '/business/SA-UTR')
    })

    router.post('/' + version + '/business/business-entity-overseas', function (req, res) {
        res.redirect(301, '/' + version + '/eligibility/agricultural-flat-rate')
    })
    ...
    router.post('/' + version + '/business/self-assessment-postcode', function (req, res) {
        req.session.dob_month = req.body.dob_month;
        if (req.session.data['fixed-establishment'] == "No") {
            res.redirect(301, '/' + version + '/business/overseas-identifier')
        } else {
            res.redirect(301, '/' + version + '/business/check-your-answers-business')
        }
    })
    ...
    router.post('/' + version + '/business/overseas-identifier', function (req, res) {
        res.redirect(301, '/' + version + '/business/check-your-answers-business')
    })

    router.post('/' + version + '/business/non-uk-company-utr', function (req, res) {
        res.redirect(301, '/' + version + '/business/overseas-identifier')
    })
    ...
    router.post('/' + version + '/business/chrn-postcode', function (req, res) {
        res.redirect(301, '/' + version + '/business/check-your-answers-business')
    })
    ...
    router.post('/' + version + '/eligibility/vat-registration-reason', function (req, res) {
        if (req.session.data['vat-reason'] == "selling goods or services and needs or wants to charge VAT to customers") {
            if (req.session.data['type_of_business'] == "Non-established taxable person (NETP)") {
                res.redirect(301, '/' + version + '/eligibility/made-or-intend-to-make-taxable-supplies')
            } else {
                res.redirect(301, '/' + version + '/eligibility/gone-over-threshold')
            }
        } else if (req.session.data['vat-reason'] == "setting up a VAT group") {
            res.redirect(301, '/' + version + '/eligibility/gone-over-threshold')
        } else if (req.session.data['vat-reason'] == "It's established or has a fixed establishment in the UK and makes or intends to make taxable supplies outside the UK only") {
            res.redirect(301, '/' + version + '/eligibility/estimated-turnover-next-12-months')
    ...
    router.post('/' + version + '/eligibility/made-or-intend-to-make-taxable-supplies', function (req, res) {
        if (req.session.data['make_taxable_supplies'] == "Yes") {
            res.redirect(301, '/' + version + '/eligibility/earliest-date-of-intend-or-made-taxable-supplies-in-uk')
        } else {
            res.redirect(301, '/' + version + '/eligibility/errors/do-not-need-to-register')
        }
    })

    router.post('/' + version + '/eligibility/earliest-date-of-intend-or-made-taxable-supplies-in-uk', function (req, res) {
        res.redirect(301, '/' + version + '/eligibility/gone-over-threshold')
    })
    ...
    router.post('/' + version + '/togc/keep-old-vrn', function (req, res) {
        let keepOldVrn = req.session.data['keep-old-vrn']
        if (keepOldVrn == "") {
            res.redirect(301, '/' + version + '/togc/keep-old-vrn?error=true')
        } else {
            res.redirect(301, '/' + version + '/eligibility/gone-over-threshold')
    ...
    router.post('/' + version + '/applicant_details/lived-at-address-less-3-years', function (req, res) {
        ...
        if (req.body.address_3_years == "No") {
            if (req.session.data['fixed-establishment'] == "No") {
                res.redirect(301, '/' + version + '/applicant_details/non-uk-address-previous')
            } else {
    ...
    router.post('/' + version + '/company_details/business-address', function (req, res) {
        if (req.session.data['address_the_same'] == "Yes") {
            ...
            if (req.session.data['fixed-establishment'] == "No") {
                res.redirect(301, '/' + version + '/company_details/non-uk-address')
            } else {
                res.redirect(301, '/' + version + '/company_details/previous-address')
            }
        }
    ...
    router.post('/' + version + '/company_details/other-business-involvements', function (req, res) {
        if (req.session.data['business_involvements'] == "Yes") {
            res.redirect(301, '/' + version + '/company_details/have-company-number')
        } else {
    ...
    router.post('/' + version + '/company_details/have-company-number', function (req, res) {
        if (req.session.data['have_crn'] == "Yes") {
            res.redirect(301, '/' + version + '/company_details/company-registration-number')
        } else {
            res.redirect(301, '/' + version + '/company_details/business-name')
        }
    })

    router.post('/' + version + '/company_details/company-registration-number', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/confirm-business-name')
    })

    router.post('/' + version + '/company_details/confirm-business-name', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/have-vat-number')
    })
    ...
    router.post('/' + version + '/company_details/have-vat-number', function (req, res) {
        if (req.session.data['have-vat-number'] == "Yes") {
            ...
            res.redirect(301, '/' + version + '/company_details/have-utr')
        }
    })

    router.post('/' + version + '/company_details/business-involvements-utr', function (req, res) {
    ...
    router.post('/' + version + '/company_details/have-utr', function (req, res) {
        if (req.session.data['have_utr'] == "Yes") {
            res.redirect(301, '/' + version + '/company_details/business-involvements-utr')
        } else {
            res.redirect(301, '/' + version + '/company_details/still-trading')
        }
    })
    ...
    router.post('/' + version + '/eligibility/zero-rated-turnover', function (req, res) {
        req.session.eligibility_completed = "Yes";
        if (req.body.zero_rated == "Yes") {
            res.redirect(301, '/' + version + '/eligibility/exemption')
        } else {
            if (req.session.data['vat-reason'] == "It's established or has a fixed establishment in the UK and makes or intends to make taxable supplies outside the UK only") {
    ...
    router.post('/' + version + '/eligibility/exemption', function (req, res) {
        req.session.eligibility_completed = "Yes";
        if (req.body.exemption == "Yes") {
            res.redirect(301, 'https://business-reg-prototype.herokuapp.com/1-89-0/vat/otrs-reg-who-can')
        } else {
            if (req.session.data['voluntarily_vat'] == "Yes") {
                res.redirect(301, '/' + version + '/eligibility/mtd-voluntarily-information')
    ...
    router.post('/' + version + '/company_details/regularly-exceed-on-vat-purchases', function (req, res) {
        ...
        if (req.session.data['fixed-establishment'] == "No") {
            res.redirect(301, '/' + version + '/company_details/send-goods-overseas')
        } else {
            if (req.session.classic_services == "Yes") {
                res.redirect(301, '/' + version + '/business/task-list-classic-services')
            } else {
                res.redirect(301, '/' + version + '/company_details/northern_ireland_activities')
            }
        }

    })

    router.post('/' + version + '/company_details/send-goods-overseas', function (req, res) {
        if (req.session.data['send_goods_overseas'] == "Yes") {
            res.redirect(301, '/' + version + '/company_details/send-goods-eu')
        } else {
            res.redirect(301, '/' + version + '/company_details/storing-goods-for-dispatch')
        }
    })

    router.post('/' + version + '/company_details/send-goods-eu', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/storing-goods-for-dispatch')
    })

    router.post('/' + version + '/company_details/using-fulfilment-warehouse', function (req, res) {
        if (req.session.data['fulfilment_warehouse'] == "Yes") {
            res.redirect(301, '/' + version + '/company_details/fulfilment-warehouse-number')
        } else {
            req.session.data['activities_sic_started'] = "No";
            req.session.data['activities_sic_completed'] = "Yes";
            res.redirect(301, '/' + version + '/company_details/northern_ireland_activities')
    ...
    router.post('/' + version + '/company_details/fulfilment-warehouse-number', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/fulfilment-warehouse-name')
    })

    router.post('/' + version + '/company_details/fulfilment-warehouse-name', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/northern_ireland_activities')
    })

    router.post('/' + version + '/company_details/storing-goods-for-dispatch', function (req, res) {
        if (req.session.data['store_goods'] == "Within the United Kindom") {
            res.redirect(301, '/' + version + '/company_details/using-fulfilment-warehouse')
        } else {
            req.session.data['activities_sic_started'] = "No";
            req.session.data['activities_sic_completed'] = "Yes";
            res.redirect(301, '/' + version + '/company_details/northern_ireland_activities')
    ...
    router.post('/' + version + '/company_details/bank-set-up', function (req, res) {
        ...
        if (req.session.data['bank'] == "Yes") {
            if (req.session.data['fixed-establishment'] == "No") {
                res.redirect(301, '/' + version + '/company_details/bank-details-overseas')
            } else {
    ...
    router.post('/' + version + '/company_details/flat-rate-start-date', function (req, res) {
    ...
    router.post('/' + version + '/company_details/bank-details-overseas', function (req, res) {
        req.session.data['bank_details_started'] = "No";
        req.session.data['bank_details_completed'] = "Yes";
        if (req.session.classic_services == "Yes") {
            res.redirect(301, '/' + version + '/business/task-list-classic-services')
    ...
    router.post('/' + version + '/company_details/flat-rate-percentage', function (req, res) {
        res.redirect(301, '/' + version + '/company_details/flat-rate-start-date')
    })
    ...
    router.post('/' + version + '/attachments/documents-required', function (req, res) {
        ...
        if (req.session.data['type_of_business'] == "Partnership") {
    ...
    router.post('/' + version + '/attachments/how-to-send', function (req, res) {
        ...
        } else if (req.session.data['additional-information'] == "Upload") {
            res.redirect(301, '/' + version + '/attachments/upload-photo-document')
        } else {
            res.redirect(301, '/' + version + '/attachments/how-to-send')
        }
    })

    router.post('/' + version + '/attachments/upload-photo-document', function (req, res) {
        res.redirect(301, '/' + version + '/attachments/uploading-photo-document')
    })

    router.post('/' + version + '/attachments/upload-second-document', function (req, res) {
        res.redirect(301, '/' + version + '/attachments/uploading-second-document')
    })

    router.post('/' + version + '/attachments/upload-third-document', function (req, res) {
        res.redirect(301, '/' + version + '/attachments/uploading-third-document')
    })

    router.post('/' + version + '/attachments/add-to-list-1', function (req, res) {
        res.redirect(301, '/' + version + '/attachments/upload-second-document')
    })

    router.post('/' + version + '/attachments/add-to-list-2', function (req, res) {
        res.redirect(301, '/' + version + '/attachments/upload-third-document')
    })

    router.post('/' + version + '/attachments/add-to-list-3', function (req, res) {
        req.session.data['attachments_started'] = "No";
        req.session.data['attachments_completed'] = "Yes";
        res.redirect(301, '/' + version + '/business/task-list')
    })
    ...
    router.post('/' + version + '/vat51/download-vat51', function (req, res) {
        res.redirect(301, '/' + version + '/vat51/how-to-send')
    })
    router.post('/' + version + '/vat51/how-to-send', function (req, res) {
        if (req.session.data['additional-information'] == "Post") {
            res.redirect(301, '/' + version + '/vat51/post-documents')
        } else if (req.session.data['additional-information'] == "Email") {
            res.redirect(301, '/' + version + '/vat51/email-documents')
        } else if (req.session.data['additional-information'] == "Upload") {
            res.redirect(301, '/' + version + '/vat51/upload-photo-document')
        } else {
            res.redirect(301, '/' + version + '/vat51/how-to-send')
        }
    })
